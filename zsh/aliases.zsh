...
# Doormat - auto-restart credential server on auth failure
alias doormat-serve='while true; do doormat login -f && doormat cred-server; echo "Restarting doormat..."; done'
